<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.*,semi.cf.jsp.member.model.vo.*"%>
  ...
  <div class="content">
    <div class="row">
      <div class="col-12">
        <!-- 세부내용 바디글 -->
        <!-- right column -->
         <form action="<%=request.getContextPath() %>/noticeWriter3.nw" 
        ...
        <div style="padding-left: 16%;">
          ...
          <div class="col-md-12" style="max-width: 90%; padding-left: 0px;">
            <div class="btn-group" style="width: 100px;">
              ...
              <span class="navbar-search pull-left" style="height: 0px;">
                <input name="title" style="width: 952px"  type="text"  placeholder=" 제목" >
              </span>
            </div>
            <div>
          ...
          <textarea id="summernote" name="content" style="height: 400px;" value="textbox" ></textarea>
          </div>
        <div>
          <div class="card-footer float-right" style="padding-left: 0px; background-color: transparent !important; border-top: white; margin-right: 256px;">
            <button type="submit" class="btn btn-info " style="border-color: #007bff; background-color: #007bff;">저장</button>
          </div>
        </div>
          </form>
            <div class="card-footer float-right" style="background-color: transparent !important; border-top: white; ">
            <button class="btn btn-default" style="position: absolute; left:1150px;border-color: #007bff;" onclick ="location.href='<%=request.getContextPath() %>/noticeList.nl?type=<%=ntype%>'">취소</button>
