...
public class NoticeSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String category  = request.getParameter("slist");
		...
		int listCount = ns.searchListCount(ntype ,category, content);
		...
		list = NoticeService.searchNotice(currentPage, limit , ntype, category,content);

		String page ="";

		if(list != null) {
			page = "views/5_board/noticeList.jsp?type="+ntype;
